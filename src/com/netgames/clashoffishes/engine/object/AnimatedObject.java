...
/**
 * AnimatedObject abstract class that functions as the basic implementation for
 * all the AnimtedObjects that are available in the game. This class will
 * primarily be used for motion sprites.
 *
 * @author Hein Dauven
 * @version %I%, %G%
 */
public abstract class AnimatedObject extends GameObject {
    ...
    /**
     * The collide method checks whether an AnimatedObject has collided with a
     * GameObject.
     *
