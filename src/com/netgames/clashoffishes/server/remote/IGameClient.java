...
public interface IGameClient extends Remote, Serializable
{
     ...
     * De server stuurt dit door naar de andere clients zodat deze hun objecten kunnen updaten.
     * De speler wordt geupdate en het object verwijderd.
    ...
    /**
     * Deze methode creert een object op het coordinaat (x, y) van het type dat meegegeven is.
