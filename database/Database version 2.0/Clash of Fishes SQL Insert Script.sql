...
-- This insert script contains dummy data for the Clash of Fishes project
	...
	-- This file contains the definition of 5 tables:
		...
		-- Table: Achievement 
		-- Contains: Achievement_ID (Auto incremented Primary Key)
		-- 			 Name
		--			 Description 
		--			 Progress_Length
		
		-- Table: Unlocked_Achievement 
		-- Contains: User_ID (Primary in combination with Achievement_ID) & (References table User.User_ID)
		-- 			 Achievement_ID (Primary in combination with User_ID) & (References table Achievement.Achievement_ID)
		--			 Unlocked 
		--			 Progress
